...
$doc->addStyleSheet ( 'modules/mod_JJSlider/css/jj-slider.css' );

$doc->addStyleSheet ( 'modules/mod_JJSlider/themes/default/default.css' );
...
$doc->addScript("modules/mod_JJSlider/js/jquery-1.6.1.min.js");
...
{
$labels[$i]='<div id="label'.$i.$moduleid.'" class="jj-html-caption">
...
$image[$i]='<img src="'.$img[$i].'" alt="" width="'.$slidewidth.'" height="'.$slideheight.'" />';

if($labels[$i]!="")
{
$image[$i]='<img src="'.$img[$i].'" alt="" title="#label'.$i.$moduleid.'" width="'.$slidewidth.'" height="'.$slideheight.'" />';
}
...
.theme-default<?php echo $moduleid;?> .jjSlider {
...
.theme-default<?php echo $moduleid;?> #slider<?php echo $moduleid;?> {
	...
	{ ?>
.theme-default<?php echo $moduleid;?> .jj-caption {
	position:absolute;
	left:0px;
	bottom:0px;
...
padding-left: 5px !important;
 ...
 .theme-default<?php echo $moduleid;?> .jj-caption h5, .theme-default<?php echo $moduleid;?>  .jj-caption h5 a{
margin:0 !important;
...
.theme-default<?php echo $moduleid;?> .jj-caption p{
...
{
?>
.theme-default<?php echo $moduleid;?> .jj-controlNavHolder
{
	position:absolute;
	left:50%;
	width:auto;
...
.theme-default<?php echo $moduleid;?> .jj-controlNav
{
	position: relative;
	left: -50%;
	top:5px;
...
{
?>
.theme-default<?php echo $moduleid;?> .jj-controlNav a {
	display:block;
	width:17px;
	height:17px;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets.png) no-repeat;
	text-indent:-9999px;
	border:0;
	margin-right:3px;
	float:left;
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a.active {
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a {
    ...
    width:18px;
    height:18px;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets2.png) no-repeat;
    text-indent:-9999px;
    border:0;
    margin-right:1px;
    float:left;
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a {
    ...
    width:8px;
    height:8px;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets3.png) left top;
    float: left; 
    text-indent: -1000px; 
}
.theme-default<?php echo $moduleid;?> .jj-controlNav a.active, .theme-default<?php echo $moduleid;?> .jj-controlNav a:hover {
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a
{
    ...
    width: 20px;
    height: 15px;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets4.png) right top;
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a
{
	...
	width:16px;
	height:15px;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets5.png) left top;
	float: left; 
	text-indent: -1000px; 
}

.theme-default<?php echo $moduleid;?> .jj-controlNav a:hover
{
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a
{
    width: 15px;
    height: 15px;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets6.png) left top;
    float: left;
    text-indent: -1000px;
    position: relative;
    margin-left: 2px;
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a
{
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets7.png) no-repeat scroll 0 0 transparent;
...
height:20px;
overflow:hidden;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets8.png) 0 0 no-repeat;
    float: left;
    text-indent: -1000px;
    position: relative;
    margin-left: 2px;
...
height:15px;
overflow:hidden;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets9.png) 0 0 no-repeat;
    float: left;
    text-indent: -1000px;
    position: relative;
    margin-left: 2px;
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a {
    ...
    width:22px;
    height:15px;
    background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets10.png) no-repeat;
    text-indent:-9999px;
    border:0;
    margin-right:3px;
    float:left;
...
.theme-default<?php echo $moduleid;?> .jj-directionNav a {
	display:none;
}
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a {
	...
	width:13px;
	height:12px;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets11.png) no-repeat;
	text-indent:-9999px;
	border:0;
	margin-right:3px;
	float:left;
...
?>
.theme-default<?php echo $moduleid;?> .jj-controlNav {
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/line.png) repeat-x 0 6px;
	z-index:20;
}
.theme-default<?php echo $moduleid;?> .jj-controlNav a {
    display:block;
    width:13px;
    height:14px;
    background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/bullets12.png) no-repeat;
    text-indent:-9999px;
    border:0;
    margin-right:15px;
    float:left;
...
.theme-default<?php echo $moduleid;?> .jj-controlNav a:last-child, a.last-child {margin-right:0px}
...
.theme-default<?php echo $moduleid;?> .jj-directionNav a {
	...
	width:30px;
	height:30px;
	background:url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows.png) no-repeat;
	text-indent:-9999px;
	border:0;
}

.theme-default<?php echo $moduleid;?> a.jj-nextNav {
	background-position:-30px 0;
	right:15px;
}

.theme-default<?php echo $moduleid;?> a.jj-prevNav {
	left:15px;
}
<?php
}
...
position:absolute;
    ...
    height: 62px;
    width: 38px;
    background-image: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows2.gif);
    display:block;
}
...
display: block;
    ...
    height: 75px;
    width: 60px;
    background-image: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows3.png);
}
...
position:absolute;
	...
	height: 56px;
	width: 29px;
    background-image: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows4.png);
}
...
position:absolute;
	...
	height: 67px;
	width: 32px;
    background-image: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows5.png);
}
...
{
	right:5px;
	background:#000 url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows6_next.png) no-repeat 50% 50%;
}

.theme-default<?php echo $moduleid;?> a.jj-prevNav
{
	left:5px;
	background:#000 url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows6_prev.png) no-repeat 50% 50%;
}
<?php
}
?>
...
.theme-default<?php echo $moduleid;?> .jj-directionNav a
{
	...
	height: 45px;
	width: 45px;
    background-image: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows7.png);
...
.theme-default<?php echo $moduleid;?> .jj-directionNav a
{
    ...
    height: 66px;
    width: 59px;
    background-image: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows8.png);    text-indent: -9000px; 
}
...
.theme-default<?php echo $moduleid;?> a.jj-nextNav:hover
{
...
.theme-default<?php echo $moduleid;?> a.jj-prevNav:hover
{
    background-position: 0 100%;
}
...
.theme-default<?php echo $moduleid;?> .jj-directionNav a
{
    ...
    height: 45px;
    width: 45px;
    background-image: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows9.png);
    display: block;    text-indent: -9000px; 
}
...
z-index: 70;
    ...
    background-image: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows10.png);
}
...
background-image: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows11.png);
...
width: 50px;
height: 50px;
background: url(<?php echo JUri::root();?>modules/mod_JJSlider/themes/default/arrows12.png) 0 50px no-repeat;
position: absolute;
cursor: pointer;
background-position:0 0;
right:19px;
...
<?php
//$doc->addScript("modules/mod_JJSlider/js/jquery.jj.slider.js");


if($jver=="1.6.1")
{
$j0=JUri::root()."modules/mod_JJSlider/js/jquery-1.6.1.min.js";
}
else
{
$j0="http://ajax.googleapis.com/ajax/libs/jquery/".$jver."/jquery.min.js";
}
$j1=JUri::root()."modules/mod_JJSlider/js/jquery.jj.slider.js";
...
<div class="joomla_pns<?php echo $moduleclass_sfx?>" >

<div class="slider-wrapper theme-default<?php echo $moduleid;?>">

            <div id="slider<?php echo $moduleid;?>" class="jjSlider">
...
{?>
 ...
 var pns = jQuery.noConflict();
     pns(window).load(function() {
        ...
        pns('#slider<?php echo $moduleid;?>').jjSlider({
