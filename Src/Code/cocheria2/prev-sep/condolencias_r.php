...
include('conexion.php');
	if ($_POST[enviar]){//AGREGA UN NUEVO MENSAJE
			...
			if(mysql_num_rows($sql)==0) {
						...
						$sql = "insert into libro(cod_l, sep_l, nombre_l, ip_l, text_l, fecha_l) values('".$max."', '".$_POST[idsep]."', '".$_POST[autor]."', '".$ip."', '".$_POST[condol]."','".$fecha."')";
		...
		<td valign="top">
			...
			<?php	
				echo '<table cellspacing="3" cellpadding="0" border="0" width="705" align="center">';
					...
					echo '<input type="radio" name="condol" value="'.$sep['text_c'].'">'.$sep['text_c'].'<BR><BR>';
					}
					echo '</td>';
					echo '</tr>';
