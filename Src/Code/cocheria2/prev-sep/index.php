...
<tr>
<?php
$sql= "SELECT * FROM sepelio WHERE localidad_sala_sep='".$_GET['salsep']."' AND LEFT(fecha_sep, 10) LIKE '".date("Y-m-d")."%'";
$contador=0;
$res=mysql_query($sql);
while($sep = mysql_fetch_array($res))
{
		...
		echo "
			...
			<tr><td>Hora de Entierro: ".$hora."</td></tr>
