...
<table width="705" align="center">
  <tr>
    <td align="center"><span class="btn1"><a href="borrar_fondo.php?idfon=<?php echo $registro_fon['cod_fon'] ?>&act=2&eli=678">Sí, Eliminar</a></span></td>
...
<?php
	...
	if($_GET['eli']==678){
		...
		{ 
			...
			header("Location:bm_fondo.php"); //NO se eliminó el registro
		}
		else
		{
			$_SESSION['error_borrar']=2;
			header("Location:bm_fondo.php");//SE eliminó el registro
		}
		mysql_close();	
	}	
}
