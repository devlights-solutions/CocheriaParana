		...
		<table width="100%">
		  <tr>
			...
			<?php
				...
				$pegar = "SELECT * FROM libro WHERE sep_l=".$_GET[idsep]." AND aprobacion = 2 ORDER BY fecha_l desc LIMIT $inicial,$cantidad";
				//$pegar = "SELECT * FROM libro WHERE sep_l=1 AND aprobacion = 2 ORDER BY fecha_l desc LIMIT $inicial,$cantidad";
				$cad = mysql_query($pegar) or die (mysql_error());
				
				$contar = "SELECT * FROM libro WHERE sep_l=".$_GET[idsep]." AND aprobacion = 2 ORDER BY fecha_l desc"; 
