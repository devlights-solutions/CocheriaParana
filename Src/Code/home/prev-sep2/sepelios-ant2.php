...
<tr>
<?php
$sql= "SELECT * FROM sepelio WHERE Localidad='".$_GET['salsep']."' AND FechaSepelio < CURRENT_DATE() ORDER BY FechaSepelio DESC";
$contador=0;
$res=mysql_query($sql);
	...
	//fin control misa
		...
		if ($sala['Sala'] == '') {
			$sala['Sala'] ='';
				...
				$salacompleta= "Sala: " . $salacompleta . " - ";
		...
		echo "
			...
			<tr><td>Hora de Inhumación: ".$hora."</td></tr>
