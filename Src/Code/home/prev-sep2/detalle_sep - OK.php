...
if($cod)
{
	...
	//fin control misa
			...
			//Controlo que la sala no sea vacía.
			...
			{
				$salafinal="Salón: ".$registro_sala['Sala']. " - ";
			}
...
<table width="705" align="center">
	...
	<tr><td><h2><?php echo ucwords(strtolower(limpiarString($registro_sep['Nombre']))) ?></h2></td></tr>
	...
	<tr><td><?php echo ucwords(strtolower($salafinal)) ?>Direcci&oacute;n:  <?php echo ucwords(strtolower(limpiarString($registro_sala['Direccion']))) ?></td></tr>
	<tr><td>Homenaje de despedida: <?php echo $partes[3] ?>/<?php echo $partes[2] ?>/<?php echo $partes[1] ?> - Hora: <?php echo $hora ?></td></tr>
	<!-- <tr><td>Hora de Entierro: <?php echo $partes[4] ?>:<?php echo $partes[5] ?></td></tr>-->
	<tr><td>Sus restos descansarán en: <?php echo ucwords(strtolower(limpiarString($lugarfinal))) ?></td></tr>
	<tr><td>
	<?php 
    ...
    <tr><td><?php if($lugarmisa !='' AND $HoraMisa != '00:00' AND $partesmisa[1] > 1910){
		echo 'Lugar de misa :';
