...
<?php
$sql= "SELECT distinct Dia, Nombre, HoraMisa FROM sepelio WHERE LugarMisa=1 AND Dia >= CURRENT_DATE() ORDER BY HoraMisa ASC";
...
<?php
$sql= "SELECT distinct fecha_mc, nombre_mc, hora_mc FROM misas_ctes WHERE lugar_mc='Hogar de Ancianos Juana de Chapo' AND fecha_mc = CURRENT_DATE() ORDER BY fecha_mc ASC";
$res = mysql_query($sql) or die ("asdasda");
$res2 = mysql_query($sql) or die ("asdasda");
$mis2 = mysql_fetch_array($res2);
