...
<title>AGRADECIMIENTOS SUCURSAL CORRIENTES</title>
...
<?php
$sql= "SELECT * FROM aggradecimiento where Estado=2 AND Destinatario=11 order by date_time desc";
$res=mysql_query($sql);
...
while($sep = mysql_fetch_array($res))
{
		...
		$sucursales= mysql_query("SELECT id, Nombre as Sucursal FROM localidad WHERE id=1 or id = 11");
